Ext.define('HERSS.view.BlogContentView', {
    ...
    config: {
        ...
        itemTpl: '<h1 style="text-align:center;padding-top:10px;">{title}</h1><hr/><div style="-webkit-overflow-scrolling:touch !important;overflow:auto !important;">{content}</div>',
        items: [{ 
                docked: 'bottom',
                ui: 'dark',
                xtype: 'toolbar',
